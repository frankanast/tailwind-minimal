export default function ToddlerIcon({className, variant="solid"}) {
    return (
        <>
            <svg
                viewBox="0 0 562.506 562.506"  /*Original: 0 0 433.506 433.506 */
                xmlns="http://www.w3.org/2000/svg"
                className={className}
                fill={(variant === "solid") ? "currentColor": "transparent"}
                preserveAspectRatio="xMidYMax meet"
            >
                <g transform="translate(0, 62.506)">
                    <g>
