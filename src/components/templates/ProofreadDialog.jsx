...
export default function ProofreadDialog({open, setOpen, onProofread}) {
    ...
    const handleProofreadClicked = async () => {
        setIsLoading(true);
        try {
            await onProofread();
                    ...
                    >
                        <div className="sm:flex sm:items-start">
                            <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-indigo-100 sm:mx-0 sm:size-10">
                                <CheckIcon aria-hidden="true" className="size-6 text-indigo-600" />
                            </div>
                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        Remove grammar and spelling errors, inconsistent whitespace and paragraphing.
                        ...
                        <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                            <button
                                type="button"
                                onClick={handleProofreadClicked}
                                disabled={isLoading}
