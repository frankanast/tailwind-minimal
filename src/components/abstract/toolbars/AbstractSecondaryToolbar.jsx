...
export function AbstractSecondaryToolbarActionDropdown({ items }) {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left justify-center">
            ...
            <MenuItems
                className="absolute right-0 z-10 mt-2 pl-4 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
            >
                <div className="py-1">
                    {isEmpty(items) ? (
                        <NoActionsIndicator />
